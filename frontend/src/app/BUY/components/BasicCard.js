    ...
    <div className="relative max-w-lg p-4">
      ...
      <div className="p-4 px-5 bg-white rounded-lg shadow-lg py-14">
        ...
        <div className='flex items-center justify-between'>
          <div>
            <p className='text-xs md:text-sm'>Together in <br /><span className='text-xs font-bold md:text-sm'>6 months</span></p>
          </div>
          <div className='text-right'>
            ...
            <br />
            <span className='text-lg font-bold md:text-xl'>119€</span>
          </div>
        </div>
      </div>
    </div>
