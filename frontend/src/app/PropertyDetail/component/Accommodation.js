...
const Accommodation = () => {
  return (
    <div className=" lg:mt-5 lg:mr-[440px] lg:ml-[18px]">
      <div className="p-4 bg-white rounded-lg sm:p-6 lg:p-6">
        {/* Header Section */}
        <div className="">
          <h2 className="text-lg font-bold sm:text-xl lg:text-2xl">Accommodation price list</h2>
        ...
        <div className="space-y-4">
          <div className="flex flex-col justify-between py-2 border-t border-gray-200 sm:flex-row sm:items-center">
            <div className="mb-2 sm:mb-0">
              <h4 className="text-sm font-semibold sm:text-base">Base rate</h4>
          ...
          <div className="flex flex-col justify-between py-2 border-t border-gray-200 sm:flex-row sm:items-center">
            <div className="mb-2 sm:mb-0">
              <h4 className="text-sm font-semibold sm:text-base">Winter season</h4>
          ...
          <div className="flex flex-col justify-between py-2 border-t border-gray-200 sm:flex-row sm:items-center">
            <div className="mb-2 sm:mb-0">
              <h4 className="text-sm font-semibold sm:text-base">Easter</h4>
